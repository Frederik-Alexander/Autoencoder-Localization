...
def _memory_maze(
    ...
    random_state = np.random.RandomState(123) # Changed seed -> 123 #FA
    ...
    arena = MazeWithTargetsArena(
        ...
        skybox_texture=None,
        random_seed=1220,# FA Changed from random_state.randint(2147483648) to 1220,
    )
    ...
    task = MemoryMazeTask(
        ...
        maze_arena=arena,
        n_targets=n_targets,
        target_radius=0.1, #Changed from 0.6 -> 0.0 FA
