...
import sys
sys.path.append('/Users/frederikalexander/My Drive/Computer Science/Bachelorarbeit Maus Topo/3D_MAZE/memory-maze-main/gui/')
...
def main(queue):
    ...
    plt.imshow(observation['maze_layout'])
    plt.show()
    ...
    while running:
        ...
        # Rendering
        queue.put([obs['agent_pos'],obs['agent_dir'],obs['image'],obs['maze_layout']] )  #obs['maze_layout']
